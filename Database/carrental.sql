...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 03, 2018 at 05:44 AM
...
(4, 'Sona Somshekar', 'DL_MND8415', '9187563240', 'Mandya', 'Female', 'roshan', 'yes'),
...
(574681256, 'rakshith', 1, 1, '2018-07-23', '2018-07-26', '2018-07-25', '2018-07-23', 1600, 'days', NULL, -1, -1600, 'R');
...
--
ALTER TABLE `rentedcars`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=574681257;
--
